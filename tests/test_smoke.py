...
EXPECTED_TOOLS = [["# Context management
    "compact_context", "# GitHub Issues
    "list_github_issues", "# Message routing
    "forward_to_worker", "# Task decomposition
    "get_task_result", "# VLM / Vision
    "analyze_screenshot", "analyze_tasks", "browse_page", "browser_action", "cancel_task", "chat_history", "claude_code_edit", "close_github_issue", "codebase_digest", "codebase_health", "comment_on_issue", "create_github_issue", "drive_list", "drive_read", "drive_write", "enable_tools", "generate_evolution_stats", "get_github_issue", "get_task_metrics", "git_diff", "git_status", "knowledge_list", "knowledge_read", "knowledge_write", "list_available_tools", "log_evolution", "multi_model_review", "promote_to_stable", "repo_commit_push", "repo_list", "repo_read", "request_restart", "request_review", "run_shell", "schedule_task", "send_owner_message", "send_photo", "summarize_dialogue", "switch_model", "toggle_consciousness", "toggle_evolution", "update_identity", "update_scratchpad", "update_user_context", "vlm_query", "wait_for_task", "web_search"]]
